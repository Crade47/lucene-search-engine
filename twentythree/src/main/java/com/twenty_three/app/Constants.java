...
public class Constants {
    ...
    public static final String corpus_fbis = BASE_DIR + "/corpus/fbis";
    public static final String corpus_fr94 = BASE_DIR + "/corpus/fr94";
    public static final String corpus_ft = BASE_DIR + "/corpus/ft";
    public static final String corpus_latimes = BASE_DIR + "/corpus/latimes";
